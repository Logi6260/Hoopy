...
const BOUNCE_VELOCITY = -8; // smaller vertical bounce
const HORIZONTAL_BOUNCE_BOOST = 1.5; // wider horizontal bounce arc
...
function update() {
  ...
  for (let i = 0; i < hoops.length; i++) {
    ...
    // Rough collision detection to score
    if (
